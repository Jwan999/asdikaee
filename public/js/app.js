...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapGetters)(["items"])),
  methods: {
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapGetters)({
    ...
    cartItem: function cartItem() {
      ...
      return this.cartItems.find(function (item) {
        return item.product.id === _this.product.id;
      });
    }
  })
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    sendUserData: function sendUserData() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/orders', {
        ...
        _this.$store.dispatch("clearCart"); // console.log(response.data.order);
  ...
  watch: {
    ...
    selected: function selected(newValue, oldValue) {
      // console.log(newVal)
      this.deliveryCharge = this.cities.find(function (city) {
        return city.name === newValue;
      }).deliveryCharge; // console.log(this.deliveryCharge)
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getProducts: function getProducts(category) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get('/api/products', {
        params: {
          category: category
        }
      }).then(function (response) {
        ...
        if (category !== undefined) {
          _this.activeCategories = category; // console.log(this.activeCategories)
        }
      });
    }
  },
  mounted: function mounted() {
    ...
    this.getProducts();
    axios__WEBPACK_IMPORTED_MODULE_2___default().get('/api/categories').then(function (response) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ProductView.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ProductView.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getProduct: function getProduct() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get('/api/product', {
        params: {
          id: this.$route.params.id
        }
      }).then(function (response) {
        _this.product = response.data.product; // console.log(response.data)
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_2__.mapGetters)({
    ...
    cartItem: function cartItem() {
      ...
      return this.cartItems.find(function (item) {
        return item.product.id === _this2.product.id;
      });
    }
  }),
  mounted: function mounted() {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ZainCash.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ZainCash.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    popupCenter: function popupCenter(_ref) {
      var _this = this;
  ...
  mounted: function mounted() {
    ...
    if (window.zain) {
      ...
      setTimeout(function () {
        window.opener.postMessage(_this2.completed, '*');
        window.close();
      }, 2000);
    }
  }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ordersStatus.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ordersStatus.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getOrders: function getOrders() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get('/api/orders', {
        params: {
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_5__.default.Store(_cart__WEBPACK_IMPORTED_MODULE_1__.default);
new vue__WEBPACK_IMPORTED_MODULE_4__.default({
  components: {
    "friends-navbar": _components_Navbar__WEBPACK_IMPORTED_MODULE_2__.default
  },
  router: router,
  store: store,
  el: "#app"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  getters: {
    items: function items(state) {
      if (!state.synced) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/cart/products', {
          params: {
    ...
    total: function total(state, getters) {
      return getters.items.reduce(function (previousValue, item) {
  ...
  mutations: {
    ADD_TO_CART: function ADD_TO_CART(state, _ref) {
      ...
      var alreadyInCart = state.items.find(function (item) {
        return item.product.id === product.id;
      });
    ...
    //     saveToLocalStorage(state.items);
    // },
    REMOVE_FROM_CART: function REMOVE_FROM_CART(state, _ref2) {
...
/* harmony import */ var _pages_Checkout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/Checkout */ "./resources/js/pages/Checkout.vue");
...
/* harmony import */ var _pages_ordersStatus__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/ordersStatus */ "./resources/js/pages/ordersStatus.vue");
/* harmony import */ var _pages_ProductView__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/ProductView */ "./resources/js/pages/ProductView.vue");
...
/* harmony import */ var _pages_ZainCash__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pages/ZainCash */ "./resources/js/pages/ZainCash.vue");
...
{
  path: "/zain-cash",
  component: _pages_ZainCash__WEBPACK_IMPORTED_MODULE_7__.default,
  name: "zain-cash",
  ...
  path: "/product/:id",
  component: _pages_ProductView__WEBPACK_IMPORTED_MODULE_4__.default
}, {
  path: "/checkout",
  component: _pages_Checkout__WEBPACK_IMPORTED_MODULE_1__.default
}, {
  path: "/about",
  ...
  path: "/orders",
  component: _pages_ordersStatus__WEBPACK_IMPORTED_MODULE_3__.default
}]);
...
/***/ "./resources/js/pages/ProductView.vue":
/*!********************************************!*\
  !*** ./resources/js/pages/ProductView.vue ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ProductView_vue_vue_type_template_id_2daabb3b___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ProductView.vue?vue&type=template&id=2daabb3b& */ "./resources/js/pages/ProductView.vue?vue&type=template&id=2daabb3b&");
/* harmony import */ var _ProductView_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ProductView.vue?vue&type=script&lang=js& */ "./resources/js/pages/ProductView.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _ProductView_vue_vue_type_template_id_2daabb3b___WEBPACK_IMPORTED_MODULE_0__.render,
  _ProductView_vue_vue_type_template_id_2daabb3b___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/ProductView.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/pages/ZainCash.vue":
/*!*****************************************!*\
  !*** ./resources/js/pages/ZainCash.vue ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ZainCash_vue_vue_type_template_id_c3948a30_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ZainCash.vue?vue&type=template&id=c3948a30&scoped=true& */ "./resources/js/pages/ZainCash.vue?vue&type=template&id=c3948a30&scoped=true&");
/* harmony import */ var _ZainCash_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ZainCash.vue?vue&type=script&lang=js& */ "./resources/js/pages/ZainCash.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _ZainCash_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _ZainCash_vue_vue_type_template_id_c3948a30_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _ZainCash_vue_vue_type_template_id_c3948a30_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "c3948a30",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/ZainCash.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/pages/ordersStatus.vue":
/*!*********************************************!*\
  !*** ./resources/js/pages/ordersStatus.vue ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ordersStatus_vue_vue_type_template_id_06cb91a0___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ordersStatus.vue?vue&type=template&id=06cb91a0& */ "./resources/js/pages/ordersStatus.vue?vue&type=template&id=06cb91a0&");
/* harmony import */ var _ordersStatus_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ordersStatus.vue?vue&type=script&lang=js& */ "./resources/js/pages/ordersStatus.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _ordersStatus_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _ordersStatus_vue_vue_type_template_id_06cb91a0___WEBPACK_IMPORTED_MODULE_0__.render,
  _ordersStatus_vue_vue_type_template_id_06cb91a0___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/ordersStatus.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/pages/ProductView.vue?vue&type=script&lang=js&":
/*!*********************************************************************!*\
  !*** ./resources/js/pages/ProductView.vue?vue&type=script&lang=js& ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/pages/ZainCash.vue?vue&type=script&lang=js&":
/*!******************************************************************!*\
  !*** ./resources/js/pages/ZainCash.vue?vue&type=script&lang=js& ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ZainCash_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ZainCash.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ZainCash.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ZainCash_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/pages/ordersStatus.vue?vue&type=script&lang=js&":
/*!**********************************************************************!*\
  !*** ./resources/js/pages/ordersStatus.vue?vue&type=script&lang=js& ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ordersStatus_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ordersStatus.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ordersStatus.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ordersStatus_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 
...
/***/ "./resources/js/pages/ProductView.vue?vue&type=template&id=2daabb3b&":
/*!***************************************************************************!*\
  !*** ./resources/js/pages/ProductView.vue?vue&type=template&id=2daabb3b& ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductView_vue_vue_type_template_id_2daabb3b___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductView_vue_vue_type_template_id_2daabb3b___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductView_vue_vue_type_template_id_2daabb3b___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ProductView.vue?vue&type=template&id=2daabb3b& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ProductView.vue?vue&type=template&id=2daabb3b&");
...
/***/ "./resources/js/pages/ZainCash.vue?vue&type=template&id=c3948a30&scoped=true&":
/*!************************************************************************************!*\
  !*** ./resources/js/pages/ZainCash.vue?vue&type=template&id=c3948a30&scoped=true& ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ZainCash_vue_vue_type_template_id_c3948a30_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ZainCash_vue_vue_type_template_id_c3948a30_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ZainCash_vue_vue_type_template_id_c3948a30_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ZainCash.vue?vue&type=template&id=c3948a30&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ZainCash.vue?vue&type=template&id=c3948a30&scoped=true&");


/***/ }),

/***/ "./resources/js/pages/ordersStatus.vue?vue&type=template&id=06cb91a0&":
/*!****************************************************************************!*\
  !*** ./resources/js/pages/ordersStatus.vue?vue&type=template&id=06cb91a0& ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ordersStatus_vue_vue_type_template_id_06cb91a0___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ordersStatus_vue_vue_type_template_id_06cb91a0___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ordersStatus_vue_vue_type_template_id_06cb91a0___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ordersStatus.vue?vue&type=template&id=06cb91a0& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ordersStatus.vue?vue&type=template&id=06cb91a0&");
...
var render = function() {
  ...
  return _c("div", { staticClass: "sticky top-0 z-10" }, [
    _c(
      "div",
      {
        staticClass:
          "flex lg:flex-row flex-col justify-between py-2 px-6 rounded-b-3xl bg-red-500 text-white"
      },
      [
        _c(
          "div",
          { staticClass: "flex items-center justify-between font-red-500" },
          [
            _vm._m(0),
            _vm._v(" "),
            _c(
              ...
              [
                _c(
                  "svg",
                  {
                    staticClass: "fill-current text-white h-7 w-7",
                    attrs: {
                      viewBox: "0 0 24 24",
                  ...
                  [
                    _c("path", {
                      attrs: {
                        d:
                          "M21 7.75H3C2.59 7.75 2.25 7.41 2.25 7C2.25 6.59 2.59 6.25 3 6.25H21C21.41 6.25 21.75 6.59 21.75 7C21.75 7.41 21.41 7.75 21 7.75Z"
                      }
                    }),
                    _vm._v(" "),
                    _c("path", {
                      attrs: {
                        d:
                          "M21 12.75H3C2.59 12.75 2.25 12.41 2.25 12C2.25 11.59 2.59 11.25 3 11.25H21C21.41 11.25 21.75 11.59 21.75 12C21.75 12.41 21.41 12.75 21 12.75Z"
                      }
                    }),
                    _vm._v(" "),
                    _c("path", {
                      attrs: {
                        d:
                          "M21 17.75H3C2.59 17.75 2.25 17.41 2.25 17C2.25 16.59 2.59 16.25 3 16.25H21C21.41 16.25 21.75 16.59 21.75 17C21.75 17.41 21.41 17.75 21 17.75Z"
                      }
                    })
                  ]
                )
          ...
          [
            ...
            _c(
              "a",
              {
                staticClass:
                  "text-xl lg:w-auto lg:ml-8 w-full transform hover:scale-110 transition ease-out duration-200",
                attrs: { target: "_blank", href: "https://www.asdikaee.com/" }
              },
            ...
            _c(
              "a",
              {
                ...
                attrs: {
                  target: "_blank",
                  href:
                    "https://www.youtube.com/channel/UCVq2GEAU0QAjYGgaxQxoh0Q"
                }
              },
              [_vm._v("قناة اصدقائي")]
            )
        ...
        _c(
          ...
          [
            _c(
              ...
              [
                _c("router-link", { attrs: { to: { path: "/checkout" } } }, [
                  _c("div", { staticClass: "relative" }, [
                    _c(
                      "span",
                      {
                        staticClass:
                          "text-white english-font text-base font-semibold bg-gray-700 rounded-full px-2 absolute top-0 -mt-3"
                      },
                      [
                        _vm._v(
                          "\n                   " +
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "fill-current text-white lg:w-8 lg:h-8 h-7 w-7",
                        attrs: {
                          viewBox: "0 0 24 24",
                          xmlns: "http://www.w3.org/2000/svg"
                        }
                      ...
                      [
                        ...
                        _c("path", {
                          attrs: {
                            d:
                              "M8.25 22.75C7.15 22.75 6.25 21.85 6.25 20.75C6.25 19.65 7.15 18.75 8.25 18.75C9.35 18.75 10.25 19.65 10.25 20.75C10.25 21.85 9.35 22.75 8.25 22.75ZM8.25 20.25C7.97 20.25 7.75 20.47 7.75 20.75C7.75 21.03 7.97 21.25 8.25 21.25C8.53 21.25 8.75 21.03 8.75 20.75C8.75 20.47 8.53 20.25 8.25 20.25Z"
                          }
                        }),
                        _vm._v(" "),
                        _c("path", {
                          attrs: {
                            d:
                              "M21 8.75H9C8.59 8.75 8.25 8.41 8.25 8C8.25 7.59 8.59 7.25 9 7.25H21C21.41 7.25 21.75 7.59 21.75 8C21.75 8.41 21.41 8.75 21 8.75Z"
                          }
                        })
                      ]
                    )
            ...
            _c(
              "button",
              { staticClass: "lg:mr-5 mr-8" },
              [
                _c("router-link", { attrs: { to: { path: "/orders" } } }, [
                  _c(
                    "svg",
                    {
                      staticClass:
                        "fill-current text-white lg:w-8 lg:h-8 h-6 w-6",
                      attrs: {
                        viewBox: "0 0 20 22",
                        version: "1.1",
                        xmlns: "http://www.w3.org/2000/svg",
                        ...
                        [
                          _c(
                            "g",
                            {
                              attrs: {
                                id: "Shop",
                                transform: "translate(-558.000000, -189.000000)"
                              }
                            },
                            [
                              _c(
                                "g",
                                {
                                  attrs: {
                                    id: "bag-2",
                                    transform:
                                      "translate(556.000000, 188.000000)"
                                  }
                                },
                                [
                                  _c("path", {
                                  ...
                                  _c("path", {
                                    attrs: {
                                      d:
                                        "M8.99981833,22.75 C4.37981844,22.75 3.51981822,20.6000001 3.29981822,18.5100002 L2.54981821,12.5200005 C2.43981821,11.4400004 2.39981836,9.88999951 3.44981831,8.72999954 C4.34981829,7.72999954 5.83981824,7.25 7.99981833,7.25 L15.9998178,7.25 C18.1698179,7.25 19.6598181,7.73999953 20.549818,8.72999954 C21.589818,9.88999951 21.5598196,11.4400001 21.4498196,12.5 L20.6998196,18.5100002 C20.4798196,20.6000001 19.6198177,22.75 14.9998178,22.75 L8.99981833,22.75 Z M4.55981827,9.73999977 C4.06981826,10.2799998 3.90981817,11.1100004 4.03981817,12.3500004 L4.78981829,18.3400002 C4.95981829,19.9400002 5.39981842,21.2600002 8.99981833,21.2600002 L14.9998178,21.2600002 C18.5998178,21.2600002 19.0398179,19.9500006 19.2098179,18.3600006 L19.9598179,12.3500004 C20.0898179,11.1300004 19.9298193,10.3 19.4398193,9.75 C18.8498194,9.07999998 17.6898179,8.75 15.9998178,8.75 L7.99981833,8.75 C6.30981827,8.75 5.14981824,9.07999974 4.55981827,9.73999977 Z",
                                      id: "Vector",
                                      fill: "#fff"
                                    }
                                  }),
                                  ...
                                  _c("path", {
                                    attrs: {
                                      d:
                                        "M14.4101562,12.1499023 C14.4101562,11.5999023 14.8601562,11.1499023 15.4101562,11.1499023 C15.9601563,11.1499023 16.4101562,11.5999023 16.4101562,12.1499023 C16.4101562,12.6999024 15.9701565,13.1499023 15.4201565,13.1499023 C14.8601565,13.1499023 14.4101562,12.6999024 14.4101562,12.1499023 Z",
                                      id: "Vector",
                                      fill: "#fff",
                                      "fill-rule": "nonzero"
                                    }
                                  ...
                                  _c("path", {
                                    attrs: {
                                      d:
                                        "M7.41015625,12.1499023 C7.41015625,11.5999023 7.86015624,11.1499023 8.41015625,11.1499023 C8.96015626,11.1499023 9.41015625,11.5999023 9.41015625,12.1499023 C9.41015625,12.6999024 8.97015649,13.1499023 8.42015648,13.1499023 C7.86015648,13.1499023 7.41015625,12.6999024 7.41015625,12.1499023 Z",
                                      id: "Vector",
                                      fill: "#fff",
                                      "fill-rule": "nonzero"
                                    }
...
var staticRenderFns = [
  function() {
    ...
    return _c("a", { attrs: { href: "/" } }, [
      _c("img", {
        staticClass: "w-32",
        attrs: { src: "/images/asdikaee.png", alt: "" }
      })
    ])
  }
]
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "shadow-lg bg-white rounded-2xl flex flex-col hover:shadow-xl"
    },
    [
      _c("a", { attrs: { href: "product/" + _vm.product.id } }, [
        _c("img", {
          staticClass:
            "rounded-t-2xl border-t-2 border-gray-700 h-96 w-full object-cover hover:opacity-80",
      ...
      _c(
        ...
        [
          _c(
            "h3",
            { staticClass: "font-bold text-xl text-red-500 text-center" },
            [_vm._v(_vm._s(_vm.product.name))]
          ),
          _vm._v(" "),
          _c("div", { staticClass: "flex justify-start mt-5" }, [
            _c("h3", { staticClass: "text-lg text-gray-800" }, [
              _c("span", { staticClass: "font-normal" }, [_vm._v("السعر: ")]),
                ...
                _vm.cartItem
                  ? _c("div", { staticClass: "grid grid-cols-4" }, [
                      _c(
                        ...
                        {
                          staticClass:
                            "bg-gray-700 text-white py-2 px-4 font-semibold text-xl rounded-2xl my-1 hover:bg-gray-800 cursor-pointer col-span-1",
                      ...
                      _c(
                        ...
                        {
                          staticClass:
                            "bg-red-500 text-white py-2 px-4 font-semibold text-xl rounded-2xl my-1 hover:bg-red-600 cursor-pointer col-span-1",
          ...
          _c(
            ...
            _vm._l(_vm.items, function(item) {
              return _c("product", {
                ...
                attrs: { "show-buttons": true, product: item.product }
              })
            }),
            1
          ),
                ...
                _c("div", { staticClass: "lg:w-7/12 w-full" }, [
                  _c(
                    ...
                    [
                      ...
                      _c("div", { staticClass: "mb-3" }, [
                        ...
                        _c(
                          "select",
                          {
                            ...
                            staticClass:
                              "rounded-2xl w-full px-3 pl-6 py-4 outline-none border-2 border-gray-300 focus:border-gray-700 bg-white",
                            attrs: { name: "city" },
                            on: {
                      ...
                      _vm._v(" "),
                      _vm._l(_vm.validationErrors.city, function(error) {
                        return _c("div", { staticClass: "w-full mb-2" }, [
                          _c("h1", { staticClass: "text-red-500 text-sm" }, [
                            _vm._v(_vm._s(error))
                          ])
    ...
    [
      ...
      _c("div", { staticClass: "w-full flex flex-col lg:px-24 px-4 mt-10" }, [
        ...
        _c("div", { attrs: { id: "store" } }, [
          ...
          _c(
            "div",
            { staticClass: "flex flex-wrap rounded-2xl justify-center" },
            [
              _c(
                "h1",
                {
                  staticClass:
                    "lg:text-xl items-center px-5 py-3 rounded-2xl font-bold ml-2 cursor-pointer lg:mt-0 mt-2",
                  class:
                    _vm.activeCategories == null
                  ...
                  _c(
                    "h1",
                    {
                      staticClass:
                        "lg:text-xl items-center px-5 py-3 rounded-2xl font-bold ml-2 cursor-pointer lg:mt-0 mt-2",
                      class:
                        _vm.activeCategories == category.id
                          ? "bg-red-500 text-white"
                          : "text-red-500 bg-red-100",
                      on: {
                        click: function($event) {
                          return _vm.getProducts(category.id)
                        }
                      }
                    },
                    [
          ...
          _c(
            ...
            _vm._l(_vm.products, function(product) {
              return _c("product", {
                ...
                attrs: { "hide-price": true, product: product }
              })
            }),
            1
          )
      ...
      [
        _c("div", { staticClass: "lg:w-6/12 w-full" }, [
          ...
          _c("p", { staticClass: "mt-10 lg:text-xl text-base" }, [
            _vm._v("عالم بلا حدود لكل من يبحث عن الثقافة والمتعة والخيال.")
          ]),
          _vm._v(" "),
        ...
        _c(
          ...
          {
            staticClass:
              "lg:w-6/12 w-full flex lg:justify-end justify-center mt-6 lg:mt-0"
          },
          [
            _c("img", {
              staticClass: "w-11/12 mt-4",
              attrs: { src: "images/charechtersWelcoming.png", alt: "" }
            })
          ]
        )
      ]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ProductView.vue?vue&type=template&id=2daabb3b&":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ProductView.vue?vue&type=template&id=2daabb3b& ***!
  \******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("navbar"),
      _vm._v(" "),
      _c("div", { staticClass: "lg:px-24 px-4 mt-10" }, [
        ...
        _c(
          ...
          [
            _c("div", { staticClass: "lg:w-5/12 w-full mt-10 lg:mt-0" }, [
              ...
              _vm._v(" "),
              _c("h1", { staticClass: "text-orange-100 text-xl mt-4" }, [
                _c("span", { staticClass: "text-dark-100 text-sm" }, [
                  _vm._v("السعر:")
                ]),
                _vm._v(
                  "\n                        " +
              ...
              _vm._v(" "),
              _vm.cartItem
                ? _c("div", { staticClass: "grid grid-cols-4 mt-10" }, [
                    _c(
                      "button",
                      {
                        staticClass:
                ...
                : _c("div", { staticClass: "grid grid-cols-5 mt-10" }, [
                    _c(
                      "button",
                      {
                        staticClass:
            ...
            _c(
              ...
              [
                _c("div", { staticClass: "w-full flex justify-center" }, [
                  _c("img", {
                    staticClass: "rounded w-96 object-cover",
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "flex flex-col space-y-10 w-8/12" }, [
    _c("input", {
      directives: [
        {
          name: "model",
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ZainCash.vue?vue&type=template&id=c3948a30&scoped=true&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ZainCash.vue?vue&type=template&id=c3948a30&scoped=true& ***!
  \***************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      _c("div", { staticClass: "flex flex-wrap lg:px-24 px-4 mt-10" }, [
        _vm.completed
          ? _c(
              ...
              {
                staticClass:
                  "w-full text-center text-success font-semibold text-4xl h-[80vh] flex justify-center items-center"
              },
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ordersStatus.vue?vue&type=template&id=06cb91a0&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/ordersStatus.vue?vue&type=template&id=06cb91a0& ***!
  \*******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _c(
    ...
    [
      ...
      !_vm.submittedEmail
        ? _c(
            "div",
            { staticClass: "w-full flex flex-col lg:px-24 px-4 mt-10" },
            [
              _c(
                "div",
                {
                  staticClass:
                    "flex justify-between items-center w-full lg:mb-10 mb-6"
                },
                [
                  _c("div", { staticClass: "lg:w-4/12 w-0" }),
                  _vm._v(" "),
                  _vm._m(0),
                  _vm._v(" "),
                  _c(
                    "div",
                    { staticClass: "flex justify-end lg:w-4/12 w-6/12" },
                    [
                      _c(
                        "button",
                        {
              ...
              _c("div", { staticClass: "flex justify-center" }, [
                _c("div", { staticClass: "lg:w-5/12 w-full" }, [
                  _c(
                    ...
                    [
                      _c("h1", { staticClass: "mb-6 text-xl text-gray-700" }, [
                        _vm._v(
                          "الرجاء ادخال البريد الاكتروني الذي سجلت به عند اتمام\n                        الطلب"
                        )
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "mb-3" }, [
        ...
        : _vm._e(),
      _vm._v(" "),
      _vm.submittedEmail && this.orders.length == 0
        ? _c("div", [
            _vm._m(1),
            _vm._v(" "),
            _c("h1", { staticClass: "lg:text-3xl text-xl mt-10 text-center" }, [
              _vm._v("لا توجد طلبات حاليا")
            ]),
            _vm._v(" "),
            _c("h1", { staticClass: "text-lg text-gray-700 text-center" }, [
              _vm._v(
                "تاكد من ادخال البريد الالكتروني الصحيح الذي ادخلته عند اتمام\n            الطلب"
              )
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "flex justify-center mb-10 mt-6" }, [
              _c(
                "button",
                {
                  staticClass:
                    "bg-gray-800 focus:bg-gray-600 py-3 px-4 text-white rounded-2xl shadow-lg mt-4 hover:bg-gray-600 cursor-pointer",
                  on: {
                    click: function($event) {
                      _vm.submittedEmail = ""
                    }
            ...
            [
              _c("div", { attrs: { id: "store" } }, [
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          {
                            staticClass:
                              "bg-gray-800 focus:bg-gray-600 py-3 px-4 text-white rounded-2xl text-sm shadow-lg hover:bg-gray-600 cursor-pointer",
                            on: {
                              click: function($event) {
                                _vm.submittedEmail = ""
                              }
                  ...
                  [
                    _c(
                      "h1",
                      {
                        staticClass:
                          "lg:text-xl items-center px-5 py-3 rounded-2xl font-bold ml-2 cursor-pointer lg:mt-0 mt-2",
                        class: !_vm.showCompleted
                          ? "bg-red-500 text-white"
                          : "text-red-500 bg-red-100",
                        on: {
                          click: function($event) {
                            _vm.showCompleted = false
                          }
                        }
                      },
                      [
                ...
                _c(
                  ...
                  [
                    _vm._l(_vm.completed, function(order) {
                      return !_vm.showCompleted
                        ? _c("div", { staticClass: "w-full" }, [
                            _c(
                              "h1",
                              {
                                staticClass:
                                  "font-bold text-2xl my-10 text-center "
                              },
                              [_vm._v("محتويات الطلب رقم " + _vm._s(order.id))]
                            ),
                            _vm._v(" "),
                            _c(
                              "div",
                              {
                                staticClass:
                                  "grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 gap-10"
                              },
                                ...
                                return _c("div", [
                                  item.product
                                    ? _c(
                                        ...
                                        {
                                          staticClass:
                                            "shadow-lg bg-white rounded-2xl flex flex-col"
                                        },
                                        [
                                          _c("img", {
                                            staticClass:
                    ...
                    _vm._v(" "),
                    _vm._l(_vm.notCompleted, function(order) {
                      return _vm.showCompleted
                        ? _c("div", { staticClass: "w-full" }, [
                            _c(
                              "h1",
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "lg:w-4/12 w-6/12" }, [
      _c(
        "h1",
        {
          staticClass:
            "lg:text-4xl text-3xl lg:text-center text-right text-red-500 font-bold"
        },
        [_vm._v("الطلبات")]
      )
    ])
